...
public class ImageLoader {
    ...
    public ImageLoader(Context context) {
        ...
        if (sOptions == null) {
        	...
        	try {
                Field inScaled = BitmapFactory.Options.class.getField(
                        "inScaled");
                Field inDensity = BitmapFactory.Options.class.getField(
                	"inDensity");
                Field inTargetDensity = BitmapFactory.Options.class.getField(
                	"inTargetDensity");
                Field densityDpi = DisplayMetrics.class.getField(
            		"densityDpi");
                
                try {
                	inScaled.setBoolean(sOptions, true);
                	inDensity.setInt(sOptions, DENSITY_MEDIUM);
                	inTargetDensity.setInt(sOptions, densityDpi.getInt(context.getResources().getDisplayMetrics()));
