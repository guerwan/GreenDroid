 ...
 */
public class SubtitleButtonItem extends TextItem {
    ...
    /**
     * The rightDrawable of the button
     */
     ...
     */
    public SubtitleButtonItem(String text, String subtitle, String buttonText, int rightDrawable) {
        super(text);
    ...
    public SubtitleButtonItem(String text, String subtitle, String buttonText, int rightDrawable, 
    		boolean enabled) {
        this(text, subtitle, buttonText, rightDrawable);
        this.enabled = enabled;
    }
    
    @Override
    public ItemView newView(Context context, ViewGroup parent) {
        return createCellFromXml(context, R.layout.gd_subtitle_button_item_view, parent);
    }
